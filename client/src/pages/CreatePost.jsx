    ...
    const generateImage = async () => {
        if(form.prompt) {
            try {
                ...
                console.log("REACT - before fetch");
    ...
    return (
        <section className="max-w-7xl mx-auto">
            ...
            <form className="mt-16  max-w-3xl" onSubmit={handleSubmit}>
                ...
                <div className="mt-10">
                    <p className="mt-2 text-[#666e75] text-[14px]">Once you have crated the image you want, you can share it with others in the community</p>
